...
func GetProductsTable(tableUrl string, productsUrl string) http.HandlerFunc {
...
func GetProduct(postUrl string) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		data := struct {
			PostURL             string
...
func PostProduct(redirectUrl string) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
